...
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE) VALUES(1, 2, 'CERTIFICAZIONE ESPOSIZIONI MACS1'),(2, 2, 'CERTIFICAZIONE TITOLI MACS1'),(3, 3, 'milestone 3'),(6, 1, 'milestone 4'), (4, 2, 'milestone 5'), (5, 3, 'milestone 6')
INSERT INTO APP.SEMAFORI (CODICE, DESCRIZIONE) VALUES('CERTMACS1','CERTIFICAZIONE MACS1'),('LOADMACS2', 'CARICAMENTO ORACLE U7B20')
INSERT INTO APP.SEMAFORI (CODICE, DESCRIZIONE) VALUES('FLUSSI_S','Arrivo flussi settimanali'),('FLUSSI_M','Arrivo flussi mensili'), ('FLUSSI_G', 'Arrivo flussi giornalieri')
...
INSERT INTO APP.CALENDARI_SEMAFORI (TAGS, ID_SEMAFORO, ID_CALENDARIO, DATA_ORA_PREVISTE) VALUES('201703', 1, 1, '2017-05-20 12:00:00'),('P201703U01', 2, 2, '2017-05-30 18:00:00')