...
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE) VALUES(1, 2, 'CERTIFICAZIONEESPOSIZIONIMACS1'),(2, 2, 'CERTIFICAZIONETITOLIMACS1')
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE) VALUES(3, 3, 'milestone 3'),(6, 1, 'milestone 4'), (4, 2, 'milestone 5'), (5, 3, 'milestone 6')
INSERT INTO APP.MILESTONE_MILESTONES (ID_MILESTONE,ID_MILESTONE_CHILD, ORDINAMENTO) VALUES(1,2,1),(2,3,2),(2,4,1),(3,5,1),(3,6,2),(2,5,1205)
...
INSERT INTO APP.CALENDARI_MILESTONE (TAGS, ID_MILESTONE, ID_CALENDARIO, DATA_ORA_PREVISTE) VALUES('201703', 1, 1, '2017-05-20 12:00:00'),('P201703U01', 2, 2, '2017-05-30 18:00:00')