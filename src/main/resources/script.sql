...
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(3, 3, 'MILESTONE 3','DESTAG MIL3')
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(6, 1, 'MILESTONE 4',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(4, 2, 'MILESTONE 5','DESTAG MIL5')
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(5, 3, 'MILESTONE 6',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(6,2,'MILESTONE 00','DESTAG MIL00')
--aggiunta nuove milestones HERMIONE + MACS1
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(8, 7, 'DISP TABELLE HERMIONE', null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(8, 9, 'CHIUSURA DATI HERMIONE',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(8, 8, 'DISP DATI HERMIONE',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(null, null, 'ELABORAZIONE DATI HERMIONE',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(3, 1, 'FINE CARICAMENTO DATI MACS1',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(3, 10, 'CERT UTENTE MACS1',null)
...
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(9, 18, 'FORNITURA FLUSSI EDWH FV-CRM',NULL)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(10, 14, 'RILASCIO ELAB DWR PER FV',NULL) 
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(10, 15, 'RILASCIO FV PER CERT','DESTAG RILASCIO FV')
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(10, 2, 'CERTIFICAZIONE FV','DESTAG CERT FV')
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(11, 16, 'RILASCIO ELAB DWR PER CRM',null)
INSERT INTO APP.MILESTONES (ID_ENTITA, ID_TIPO_EVENTO, DESCRIZIONE, DESCRIZIONE_TAG) VALUES(11, 17, 'RILASCIO CRM PER CERT',null)
